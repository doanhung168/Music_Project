...
public enum Event {
    ...
    ADD_PLAYLIST_SUCCESS_EVENT,
    LOADING_MY_PLAYLIST_FAILURE_EVENT,
    REMOVE_PLAYLIST_SUCCESS,
    REMOVE_PLAYLIST_FAILURE,
    LOADING_ALL_ALBUM_FAILURE,
    LOADING_ARTISTS_FAILURE,
    LOADING_TOP_SONG_OF_ARTIST,
    LOADING_TOP_ALBUM_OF_ARTIST,
    LOADING_GENRE_FAILURE,
    LOADING_SONGS_OF_ALBUM_FAILURE,
    ADD_A_SONG_TO_PLAYLIST_FAILURE,
    ADD_A_SONG_TO_PLAYLIST_SUCCESS,
    LOADING_SONGS_OF_PLAYLIST_FAILURE,
    GET_PLAYLIST_IDS_OF_A_SONG_FAILURE,
    NAVIGATE_MUSIC_PLAYING_PLAYLIST_FRAGMENT,
    NAVIGATE_MUSIC_PLAYING_PLAYLIST_FRAGMENT_2, LOADING_RECENTLY_SONGS_FAILURE;
