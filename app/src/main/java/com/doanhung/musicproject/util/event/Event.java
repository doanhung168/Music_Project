...
public enum Event {
    ...
    SHOW_PLAYLIST_DIALOG, ADD_PLAYLIST_FAILURE_EVENT, ADD_PLAYLIST_SUCCESS_EVENT, LOADING_MY_PLAYLIST_FAILURE_EVENT, REMOVE_PLAYLIST_SUCCESS, REMOVE_PLAYLIST_FAILURE, LOADING_ALL_ALBUM_FAILURE, LOADING_ARTISTS_FAILURE, LOADING_TOP_SONG_OF_ARTIST, LOADING_TOP_ALBUM_OF_ARTIST;
